	...
	var viewStackCard = function (_p2) {
		...
		if (_p4.ctor === 'PlayerA') {
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('playera')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						viewCard(_p5)
			...
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('playerb')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						viewCard(_p5)
...
var _user$project$GameState$viewLife = function (_p6) {
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('life')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
...
var _user$project$GameState$viewTurn = function (turn) {
	...
	if (_p8.ctor === 'PlayerA') {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('turn-indi pass-button'),
					_elm_lang$html$Html_Events$onClick(_user$project$Messages$EndTurn)
				]),
			_elm_lang$core$Native_List.fromArray(
				[
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('turn-indi enemy-turn')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
...
var _user$project$GameState$viewOtherHand = function (hand) {
	var viewCard = function (card) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('card other-card')
				]),
			_elm_lang$core$Native_List.fromArray(
				[]));
	};
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('hand other-hand')
			]),
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(_p10.desc)
						]))
				]));
	};
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('hand my-hand')
			]),
		A2(_elm_lang$core$List$map, viewCard, hand));
};
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_user$project$GameState$viewLife(
...
var _user$project$GameState$init = {
	hand: _elm_lang$core$Native_List.fromArray(
		[]),
	otherHand: _elm_lang$core$Native_List.fromArray(
		[]),
...
var _user$project$GameState$decodeState = function (msg) {
	var makeStackCard = F2(
		function (s, c) {
			var _p12 = s;
			switch (_p12) {
				case 'pa':
					return A2(_user$project$GameState$StackCard, _user$project$GameState$PlayerA, c);
				case 'pb':
					return A2(_user$project$GameState$StackCard, _user$project$GameState$PlayerB, c);
				default:
					return _elm_lang$core$Native_Utils.crashCase(
						'GameState',
						{
							start: {line: 202, column: 7},
							end: {line: 208, column: 49}
						},
						_p12)('Invalid stack card owner');
			}
		});
	var cardDecoder = A4(
	...
	if (_p14.ctor === 'Ok') {
		switch (_p14._0._0) {
			case 'pa':
				return _elm_lang$core$Result$Ok(
					{ctor: '_Tuple6', _0: _user$project$GameState$PlayerA, _1: _p14._0._1, _2: _p14._0._2, _3: _p14._0._3, _4: _p14._0._4, _5: _p14._0._5});
			case 'pb':
				return _elm_lang$core$Result$Ok(
					{ctor: '_Tuple6', _0: _user$project$GameState$PlayerB, _1: _p14._0._1, _2: _p14._0._2, _3: _p14._0._3, _4: _p14._0._4, _5: _p14._0._5});
			default:
				return _elm_lang$core$Result$Err(
					A2(_elm_lang$core$Basics_ops['++'], 'Invalid turn, should be pa or pb but is instead ', _p14._0._0));
		}
	} else {
	...
	function (model, msg) {
		...
		if (_p15.ctor === 'Ok') {
			return _elm_lang$core$Native_Utils.update(
				model,
				{turn: _p15._0._0, hand: _p15._0._1, otherHand: _p15._0._2, life: _p15._0._3, otherLife: _p15._0._4, stack: _p15._0._5});
		} else {
			return _elm_lang$core$Native_Utils.crashCase(
				'GameState',
				{
					start: {line: 169, column: 5},
					end: {line: 173, column: 49}
				},
				_p15)(
				A2(_elm_lang$core$Basics_ops['++'], 'Sync hand error: ', _p15._0));
		}
	});
var _user$project$GameState$update = F2(
	function (msg, model) {
		var _p17 = msg;
		return A2(_user$project$GameState$syncModel, model, _p17._0);
	});

var Elm = {};
Elm['GameState'] = Elm['GameState'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['GameState'], 'GameState', typeof _user$project$GameState$main === 'undefined' ? null : _user$project$GameState$main);

...
var _user$project$Chat$getPosition = function (_p2) {
	...
	if (_p4.ctor === 'Nothing') {
		...
		var _p6 = _p4._0.start;
		var _p5 = _p4._0.current;
		return A2(_elm_lang$mouse$Mouse$Position, (_p7.x + _p5.x) - _p6.x, (_p7.y + _p5.y) - _p6.y);
	}
};
var _user$project$Chat$dragEnd = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{
			pos: _user$project$Chat$getPosition(model),
			drag: _elm_lang$core$Maybe$Nothing
		});
};
var _user$project$Chat$view = function (model) {
	var realPos = _user$project$Chat$getPosition(model);
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('chat'),
				_user$project$Chat$draggable,
...
var _user$project$Chat$Drag = F2(
	function (a, b) {
		return {start: a, current: b};
	});
var _user$project$Chat$dragStart = F2(
	function (model, pos) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				drag: _elm_lang$core$Maybe$Just(
					A2(_user$project$Chat$Drag, pos, pos))
			});
	});
var _user$project$Chat$dragAt = F2(
	function (model, pos) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				drag: A2(
					...
					function (_p8) {
						var _p9 = _p8;
						return A2(_user$project$Chat$Drag, _p9.start, pos);
					},
					model.drag)
			});
	});

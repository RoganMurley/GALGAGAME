module Render.Shaders exposing (circleFragment, disintegrate, donutFragment, fragment, fragmentAlpha, fragmentGrayscale, fragmentTransmute, fullCircleFragment, laser, matte, ornate, trail, tunnel, vertex)

...
main = defaultMain $
  testGroup "Mirror"
    [
      testGroup "WhichPlayer" $ unwrap (mirrorProperties :: MirrorTestTree WhichPlayer)
    , testGroup "StackCard"   $ unwrap (mirrorProperties :: MirrorTestTree StackCard)
    , testGroup "Model"       $ unwrap (mirrorProperties :: MirrorTestTree Model)
    , testGroup "GameState"   $ unwrap (mirrorProperties :: MirrorTestTree GameState)
    , testGroup "CharModel"   $ unwrap (mirrorProperties :: MirrorTestTree CharModel)
    ]


data MirrorTestTree a = MirrorTestTree [TestTree]


unwrap :: MirrorTestTree a -> [TestTree]
